...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    WXLoginViewController *loginViewController = [[WXLoginViewController alloc] init];

//    [loginViewController setView:[[WXLoginView alloc] init]];
//
//    loginViewController.view.backgroundColor
